...
export default function StudentAdvisorPage() {
  ...
  const channels = [
    ...
    },
    {
      ...
      title: "Cổng đào tạo ASC",
      desc: "Tra cứu và đăng ký học phần tại cổng chính thức",
      action: "Truy cập ASC Portal",
      href: "https://asc.vlu.edu.vn",
