...
export default function Me() {
  ...
  const handleUpdate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(errObj.response?.data?.message || "Không thể cập nhật thông tin. Vui lòng thử lại.");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-8 space-y-6 relative">
        ...
        <div className="flex flex-col items-center space-y-4 border-b border-zinc-100 pb-6 text-center sm:flex-row sm:space-y-0 sm:space-x-6 sm:text-left">
          ...
          <div className="space-y-1">
            ...
            <div className="flex flex-wrap gap-2 justify-center sm:justify-start">
              <span className="inline-flex items-center gap-1 rounded-full bg-violet-55/10 bg-violet-50 px-2.5 py-0.5 text-xs font-semibold text-violet-600 border border-violet-100">
                <Shield size={12} />
                Học viên portal
              </span>
        ...
        <form onSubmit={handleUpdate} className="mt-6 space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="pt-2 border-t border-zinc-100">
              ...
              <p className="text-xs text-zinc-400">Không điền nếu bạn không muốn thay đổi mật khẩu hiện tại.</p>
            </div>
