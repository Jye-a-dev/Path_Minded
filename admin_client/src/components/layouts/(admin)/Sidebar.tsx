  ...
  const menuSections = [
    {
      ...
      items: [
        ...
        { label: "Advisors", to: "/admin/advisors", icon: Briefcase },
    ...
    },
    {
      ...
      items: [
        { label: "Curriculum Courses", to: "/admin/curriculum_courses", icon: Bookmark },
        { label: "Prerequisites", to: "/admin/course_prerequisites", icon: GitFork },
        { label: "Equivalencies", to: "/admin/course_equivalencies", icon: RefreshCw },
        { label: "Course Results", to: "/admin/student_course_results", icon: FileSpreadsheet },
      ],
    },
    {
      title: "Import Sessions",
      items: [
        { label: "Curriculum Imports", to: "/admin/curriculum_imports", icon: UploadCloud },
        { label: "Transcript Uploads", to: "/admin/transcript_uploads", icon: FileUp },
        { label: "Class Imports", to: "/admin/class_imports", icon: FolderInput },
        { label: "Class Import Rows", to: "/admin/class_import_rows", icon: ListOrdered },
      ],
    },
    {
      title: "Data Exports",
      items: [
        { label: "Exports", to: "/admin/exports", icon: DownloadCloud },
        { label: "Export Logs", to: "/admin/export_logs", icon: History },
      ],
    },
    {
      title: "System Config",
      items: [
        { label: "Parse Warnings", to: "/admin/parse_warnings", icon: AlertTriangle },
      ],
    },
  ];
      ...
      <div className="flex h-16 items-center justify-between px-6 border-b border-slate-800/80">
        <Link to="/admin" className="flex items-center gap-2" onClick={() => setSidebarOpen(false)}>
          ...
          <span className="text-lg font-bold tracking-tight text-white">
            PathMinded <span className="text-indigo-400 text-xs font-semibold px-1 py-0.5 rounded bg-indigo-950 border border-indigo-800">Admin</span>
          </span>
        </Link>
        <button
