    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="space-y-1">
          ...
          <input
            type="text"
            required
            placeholder="Enter UUID of source record"
            value={formSourceId}
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="space-y-1">
          ...
          <input
            type="text"
            required
            placeholder="e.g. INVALID_LETTER_GRADE"
            value={formCode}
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="space-y-1">
          ...
          <input
            type="text"
            required
            placeholder="Provide a clear description of the warning..."
            value={formMessage}
      ...
      <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-800">
        ...
        >
          ...
          {editingItem ? "Save Changes" : "Create Warning"}
        </button>
      </div>
    </form>
  );
