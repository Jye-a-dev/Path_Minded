...
export default function Users() {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (row: UserItem) => (
        <span className="text-slate-400 font-normal">{row.display_name || "N/A"}</span>
      ),
    },
    {
      header: "Role",
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-extrabold tracking-tight text-white m-0">User Directory</h1>
          <p className="mt-1 text-xs text-slate-400">
            Create, update, and manage student, advisor and admin system accounts.
          </p>
        </div>
      </div>
      ...
      <Modal
        ...
        title={editingItem ? "Edit Account Role" : "Create System Account"}
      >
        <UserForm
