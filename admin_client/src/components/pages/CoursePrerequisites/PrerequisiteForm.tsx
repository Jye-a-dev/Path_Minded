    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      {loadingDropdowns ? (
        ...
        <div className="space-y-1">
          ...
          >
            <option value="">-- Choose Curriculum Program --</option>
            {programsList.map((p) => (
      ...
      <div className="space-y-1">
        ...
        <select
          ...
          className="w-full rounded-lg border border-slate-850 bg-slate-950 px-3 py-2 text-sm text-slate-100 focus:border-indigo-500 focus:outline-none transition-all"
        >
          <option value="REQUIRED">REQUIRED (Strict blocker)</option>
          <option value="RECOMMENDED">RECOMMENDED (Informative warning only)</option>
        </select>
      </div>
