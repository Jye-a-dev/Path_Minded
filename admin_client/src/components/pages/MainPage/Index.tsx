      ...
      <div className="relative overflow-hidden rounded-3xl border border-zinc-200/80 bg-white/70 p-8 md:p-12 shadow-2xl backdrop-blur-md transition-all hover:shadow-indigo-500/5 dark:border-slate-800/80 dark:bg-slate-900/50">
        <div className="flex flex-col items-center space-y-4">
          <div className="inline-flex items-center gap-1 rounded-full bg-indigo-600/10 px-3 py-1 text-xs font-semibold text-indigo-600 dark:bg-indigo-500/15 dark:text-indigo-400 border border-indigo-500/20">
            ...
            PathMinded Portal v1.0
          </div>
          
          <h1 className="text-4xl md:text-5xl font-black tracking-tight text-zinc-900 dark:text-white leading-none">
            Academic Advising <span className="text-indigo-600 dark:text-indigo-400">Matrix Control</span>
          </h1>
          
          <p className="max-w-2xl text-sm md:text-base text-zinc-500 dark:text-slate-400 font-medium">
            Integrate curriculum matrices, process student study transcript uploads, audit course prerequisites, and export structural class logs.
          </p>
          ...
          <div className="grid gap-4 mt-8 w-full sm:grid-cols-3">
            <div className="rounded-xl border border-zinc-200/60 bg-white/40 p-5 dark:border-slate-800/60 dark:bg-slate-950/20">
              ...
              <h3 className="mt-2 text-sm font-bold text-zinc-800 dark:text-white">Parsing Pipelines</h3>
              <p className="text-xs text-zinc-550 dark:text-slate-500 mt-1">Automatic transcript analysis</p>
            </div>
            
            <div className="rounded-xl border border-zinc-200/60 bg-white/40 p-5 dark:border-slate-800/60 dark:bg-slate-950/20">
              <BookOpen className="h-6 w-6 mx-auto text-indigo-500" />
              <h3 className="mt-2 text-sm font-bold text-zinc-800 dark:text-white">Syllabus Matrix</h3>
              <p className="text-xs text-zinc-550 dark:text-slate-500 mt-1">Syllabi mapping and prerequisite audits</p>
            </div>
            
            <div className="rounded-xl border border-zinc-200/60 bg-white/40 p-5 dark:border-slate-800/60 dark:bg-slate-950/20">
              <ShieldAlert className="h-6 w-6 mx-auto text-indigo-500" />
              <h3 className="mt-2 text-sm font-bold text-zinc-800 dark:text-white">Role Directory</h3>
              <p className="text-xs text-zinc-550 dark:text-slate-500 mt-1">Advanced advisor & admin access control</p>
            </div>
          </div>
